...
const AddCarPage = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement | HTMLSelectElement>) => {
    ...
    } else if (name === 'rentalPrice' || name === 'year') {
      setFormData({
        ...formData,
                ...
                <div className="flex items-center justify-between py-4">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      {formData.available ? 'Car is available for rent' : 'Car is not available for rent'}
                    </p>
                  </div>
                  <button
                    type="button"
                    ...
                    className={`${
                      formData.available ? 'bg-indigo-600' : 'bg-gray-200'
